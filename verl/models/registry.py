...
_MODELS = {
    ...
    "GemmaForCausalLM": ("gemma", ("ParallelGemmaForCausalLMRmPadPP", "ParallelGemmaForValueRmPadPP",
                                   "ParallelGemmaForCausalLMRmPad")),
}

if _HAS_GEMMA3:
    _MODELS["Gemma3ForCausalLM"] = ("gemma3", ("ParallelGemma3ForCausalLMRmPadPP", "ParallelGemma3ForValueRmPadPP",

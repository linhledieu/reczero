...
def apply_monkey_patch_to_gemma3():
    try:
        from transformers.models.gemma3.modeling_gemma3 import Gemma3FlashAttention2
        from verl.models.transformers.gemma3 import gemma3_flash_attn_forward
        Gemma3FlashAttention2.forward = gemma3_flash_attn_forward
    except ImportError:
        # Fallback to Gemma if Gemma3 not available
        from transformers.models.gemma.modeling_gemma import GemmaFlashAttention2
        from verl.models.transformers.gemma3 import gemma3_flash_attn_forward
        GemmaFlashAttention2.forward = gemma3_flash_attn_forward


_PATCH_NAME_TO_FUNC = {
    'llama': apply_monkey_patch_to_llama,
    'qwen2': apply_monkey_patch_to_qwen2,
    'gemma3': apply_monkey_patch_to_gemma3,
}

...
import torch
from verl.utils.reward_score import gsm8k, math, multiply, countdown, kk, amazon_rate, rec_rate_format, rec_rate_wtk, amazon_ctr, sem_seq_rec
...
def _select_rm_score_fn(data_source):
    if data_source == 'openai/gsm8k':
        ...
        return rec_rate_format.compute_score
        # return rec_rate_wtk.compute_score

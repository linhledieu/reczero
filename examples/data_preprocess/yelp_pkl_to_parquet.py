...
Usage examples:
  ...
  python yelp_pkl_to_parquet.py --pkl_path train.pkl --output_path train.parquet --split train

  # val/test (history from train)
  python yelp_pkl_to_parquet.py --pkl_path val.pkl --history_pkl_path train.pkl --output_path val.parquet --split val
  python yelp_pkl_to_parquet.py --pkl_path test.pkl --history_pkl_path train.pkl --output_path test.parquet --split test
"""
...
def main(pkl_path: str, output_path: str, min_his_len: int, max_user_his: int,
    ...
    for idx, row in tqdm(data_df.iterrows(), total=len(data_df)):
        ...
        # User history: all reviews by this user in history_df before this timestamp
        ...
        # Item history: all reviews for this item in history_df before this timestamp
        ...
        # Build user history text (same format as existing parquet)
        user_history_text = ""

...
# 保存为 JSONL 文件
with open(f'/home/huangyanwen.hyw/code_linlin/Logic-RL-rating/data/Reason4Rec/{dataset}/raw_features_data_test.jsonl', 'w', encoding='utf-8') as f:
    for entry in jsonl_data:
        f.write(json.dumps(entry, ensure_ascii=False) + '\n')

print(f"Generated {len(data_df_sample)} samples using raw features")
print(f"Saved JSONL to: /home/huangyanwen.hyw/code_linlin/Logic-RL-rating/data/Reason4Rec/{dataset}/raw_features_data_test.jsonl")
